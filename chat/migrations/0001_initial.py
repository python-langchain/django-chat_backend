    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pair_key', models.CharField(db_index=True, max_length=64, unique=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['chat', 'created_at'], name='chat_created_idx'), django.contrib.postgres.indexes.GinIndex(fields=['metadata'], name='message_meta_gin')],
            },
        ),
    ]
